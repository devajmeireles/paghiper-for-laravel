...
it('should be able to throw exception due incorrect cast type', function () {
    ...
    $this->expectExceptionMessage("The cast: BilletNotification is not supported. Please, review the docs.");
    ...
    (new PagHiper())->pix(Cast::BilletNotification)->create(...fakePixCreationBody());
});
